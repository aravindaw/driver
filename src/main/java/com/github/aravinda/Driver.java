...
public class Driver {
    ...
    public void createTestEnvironment() throws ConfigurationException {
        ...
        if (os.equals(DriverSet.OS.LINUX)) {
            System.setProperty("webdriver.chrome.driver", config.getProperty("DRIVER_LINUX").toString());
        } else if (os.equals(DriverSet.OS.WINDOWS)) {
            System.setProperty("webdriver.chrome.driver", config.getProperty("DRIVER_WINDOWS").toString());
        } else if (os.equals(DriverSet.OS.MAC)) {
            System.setProperty("webdriver.chrome.driver", config.getProperty("DRIVER_MAC").toString());
        }
